...
$url = 'https://github.com/cli/cli/releases/download/v0.5.5/gh_0.5.5_windows_amd64.msi' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName   = 'github.cli*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
